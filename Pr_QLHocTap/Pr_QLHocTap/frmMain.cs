...
namespace Pr_QLHocTap
{
    public partial class frmMain : Form
    {
        ...
        string strConn = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\CSDL\CSDL\CSDL_QLHocTap.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            if (admin == "admin")
            {
                lbWelcome.Text = "Xin chào Admin, Ninh Thị Thanh Tâm !";
            }
            else
            {
